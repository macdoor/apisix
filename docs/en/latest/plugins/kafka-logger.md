...
| tls                    | object  | False    |                |                       | enable Kafka broker TLS connection            |
| tls.verify             | boolean | False    | false          |                       | whether to verify the Kakfa broker certificate when setup a TLS connection to Kakfa broker           |
